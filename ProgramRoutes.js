...
//todo test
    ...
    app.post('/getAllChecksByCashier/id_employee', checkRouter.getAllChecksByCashier)
    app.get('/getAllChecksByCashierForPeriod', checkRouter.getAllChecksByCashierForPeriod)
